...
`;
    ...
    class PressurePass extends ShaderPass {
      ...
      update(params: { vel: any; pressure: any }) {
        this.uniforms.velocity.value = params.vel.texture;
    ...
    class Simulation {
      ...
      constructor(options?: any) {
        ...
        this.fbos = {
          vel_0: null as any,
          vel_1: null as any,
          vel_viscous0: null as any,
          vel_viscous1: null as any,
          div: null as any,
          pressure_0: null as any,
          pressure_1: null as any,
        };
        this.init();
      }
      init() {
      ...
      createShaderPass() {
        ...
        this.viscousPass = new ViscousPass({
          cellScale: this.cellScale,
