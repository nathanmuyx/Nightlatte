...
export function HeroScroll() {
  ...
  // Mobile: wider spread (±300) so cards don't overlap at 0.5 scale
  const card1X = useTransform(scrollYProgress, isMobile ? [0, 1] : [0, 0.5, 1], isMobile ? [0, -300] : [0, -324, -460]);
  const card2X = useTransform(scrollYProgress, [0, 0.5, 1], [0, 0, 0]);
  const card3X = useTransform(scrollYProgress, isMobile ? [0, 1] : [0, 0.5, 1], isMobile ? [0, 300] : [0, 324, 460]);
